...
class EnvironmentResourceDescription(BaseModel):
    ...
    def from_json(cls, json_data):
        ...
        erd._resources = []
        try:
            if json_data['Resources'] is not None:
...
class ResourceDescription(BaseModel):
    ...
    def from_json(cls, json_data):
        ...
        rd._properties = []
        if json_data['Properties'] is not None:
            for resource_property in json_data['Properties']:
...
class ConfigurationSettingsDescription(BaseModel):
    ...
    def from_json(cls, json_data):
        ...
        for setting in json_data['OptionSettings']:
