...
import codecs, os, logging as _logging, urllib.request, urllib.parse, urllib.error, urllib.parse

from lib.aws import requests
from scli import prompt
from scli import config_file 
from scli.constants import EbDefault, EbLocalDir, ParameterName, ParameterSource, \
    EnvironmentHealth, EnvironmentStatus, ServiceDefault, ValidationSeverity
...
class CreateEnvironmentOperation(OperationBase):
    ...
    def execute(self, parameter_pool):
        ...
        option_remove = dict()                 
        self._option_setting_handler(parameter_pool, spec, stack_name, option_settings, option_remove)
